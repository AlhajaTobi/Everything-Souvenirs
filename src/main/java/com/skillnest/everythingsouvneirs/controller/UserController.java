...
import com.skillnest.everythingsouvneirs.dtos.UserDto;
import com.skillnest.everythingsouvneirs.dtos.request.*;
import com.skillnest.everythingsouvneirs.dtos.response.FoundResponse;
import com.skillnest.everythingsouvneirs.dtos.response.LoginResponse;
import com.skillnest.everythingsouvneirs.dtos.response.UploadResponse;
...
public class UserController {
    ...
    public ResponseEntity<LoginResponse> googleLogin(@RequestBody GoogleLoginRequest request) {
        try {
            ...
            LoginResponse loginResponse = userService.handleGoogleLogin(email, name);
