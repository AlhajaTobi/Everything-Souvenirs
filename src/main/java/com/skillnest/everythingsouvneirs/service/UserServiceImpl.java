...
import com.skillnest.everythingsouvneirs.mapper.UserMapper;
...
public class UserServiceImpl implements UserService{
    ...
    public OTPResponse sendVerificationOTP(CreateUserRequest request) {
        ...
        String otp = com.skillnest.userservice.util.OTPGenerator.generateOtp();
    ...
    public ResetPasswordResponse sendResetOtp(ResetPasswordRequest resetPasswordRequest){
        ...
        OTP otp = new OTP();
        otp.setOtp(com.skillnest.userservice.util.OTPGenerator.generateOtp());
